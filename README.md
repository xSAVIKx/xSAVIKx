...
<!-- posts start -->
- [Your llms.txt guide is out of date: what v2 changed](https://serhiichuk.dev/blog/llms-txt-v2-what-changed/) — 21 Aug 2026
- [Building an Autonomous SRE Agent with Google ADK and the Antigravity SDK](https://serhiichuk.dev/blog/building-an-sre-agent-with-adk-and-antigravity/) — 9 Jul 2026
- [Open Knowledge Format — portable digital map of your data as code](https://serhiichuk.dev/blog/open-knowledge-format-portable-digital-map-of-your-data-as-code/) — 15 Jun 2026
- [Cloud Workstations: building reusable development environments in cloud — Part 2](https://serhiichuk.dev/blog/cloud-workstations-building-reusable-development-environments-in-cloud-part-2/) — 17 Nov 2025
- [Cloud Workstations: building reusable development environments in cloud](https://serhiichuk.dev/blog/cloud-workstations-building-reusable-development-environments-in-cloud/) — 26 Oct 2025
<!-- posts end -->
